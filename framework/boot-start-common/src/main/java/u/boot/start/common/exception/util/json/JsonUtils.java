package u.boot.start.common.exception.util.json;
...
import u.boot.start.common.exception.util.date.DateConvertUtils;
import u.boot.start.common.exception.util.str.StrPool;
...
public class JsonUtils {
    ...
    public static boolean isJson(String text) {
        if (!text.startsWith(StrPool.DELIM_START) || text.endsWith(StrPool.DELIM_END)) {
            return false;
        }
